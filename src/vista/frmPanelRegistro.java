...
public class frmPanelRegistro extends javax.swing.JFrame {

   
    public frmPanelRegistro() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel3.setAlignmentX(170.0F);
        jPanel3.setAlignmentY(-180.0F);

        jLabel10.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setText("           CREAR");

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/registro.png"))); // NOI18N
        ...
        jLabel12.setText("             LISTA");

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/lista.png"))); // NOI18N
        ...
        jLabel13.setText("          IMPORTAR");

        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/impoexcel.png"))); // NOI18N
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/expoExcel.png"))); // NOI18N
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/REPORTE.png"))); // NOI18N
        ...
        panelregistro.setBackground(new java.awt.Color(0, 0, 102));
        panelregistro.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255), 2));
